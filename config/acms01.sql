...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2020 at 06:25 PM
...
(24, 'issam', 'issam', 'fname1', 'lname1', 'issam@issam.com', NULL, 1, 0, '2020-03-16 17:22:07', 'Men', 'Men', 'zaaa', 'qwe', NULL, NULL, '33.030148', '-7.196091', 100, '2020-06-17 17:41:43', 20, 0),
...
CREATE TABLE `visitor` (
  ...
  `lname` varchar(50) DEFAULT NULL,
  `cin` varchar(8) CHARACTER SET utf8mb4 DEFAULT NULL,
  `address` varchar(1000) CHARACTER SET utf8mb4 DEFAULT NULL,
  `service` varchar(320) CHARACTER SET utf8mb4 DEFAULT NULL,
  `subject` varchar(10000) CHARACTER SET utf8mb4 DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
...
INSERT INTO `visitor` (`visitor_id`, `fname`, `lname`, `cin`, `address`, `service`, `subject`, `created_at`) VALUES
(34, 'aa', 'aa', 'aa', 'aa', 'Men', 'aa', '2020-06-19 19:43:26'),
(41, 'لالالااا', 'الالالالالاا', 'الالاالا', 'ال', 'DRHMG', 'ال', '2020-06-19 20:41:49'),
(42, 'hg', 'hg', 'ad209861', 'hghhgh', 'PN', 'ghghghg', '2020-06-19 20:42:27'),
(44, 'ضضض', 'ضضضض', 'ضضضضض', 'صصصصصص', 'DRHMG', 'صصصصصصص صصصص', '2020-06-21 17:32:03'),
(45, 'ضضضضض', 'ضضضضضض', 'ضضضضض', 'صصصصص', 'DRHMG', 'صصضضضضض ضضضضض', '2020-06-21 17:32:28');
